...
console.clear();
console.log('Made By @nminhniee \x1b[31mwith luv <3\x1b[0m');
...
console.log('- Method: \x1b[34mGET\x1b[0m');
console.log(`- Proxyfile: [\x1b[34m${args.proxyFile}\x1b[0m] Total(s): [\x1b[34m${proxies.length}\x1b[0m]`);
console.log('-------------------------');
